<div class="form-field">
	...
	<p>
		<input type="button" class="button button-secondary ct_tax_media_button" id="<?php echo $slug ?>_ct_tax_media_button" name="ct_tax_media_button" value="<?php _e( 'Add Image', 'hero-theme' ); ?>" />
		<input type="button" class="button button-secondary ct_tax_media_remove" id="<?php echo $slug ?>_ct_tax_media_remove" name="ct_tax_media_remove" value="<?php _e( 'Remove Image', 'hero-theme' ); ?>" />
	</p>
</div>
